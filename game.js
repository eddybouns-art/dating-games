...
kaboom({
  ...
  width: 384,   // NES-iges Seitenverhältnis
  height: 216,
  scale: 3,     // hübsch groß
  background: [26, 20, 35], // dunkles Lila
});
...
// UI: Partikelregen
function sparkleBurst(posi, n=8){
  for (let i=0;i<n;i++){
    const s = add([
      sprite("spark"),
      pos(posi.add(rand(-6,6), rand(-6,6))),
      anchor("center"),
      scale(rand(0.8,1.4)),
